...
public class AddEmploye extends javax.swing.JFrame {
    ...
    void add()
    {
        ...
        Employe employe;
        employe = new Employe(FieldNom.getText(), FieldPrenom.getText(), FieldAdresse.getText(), FieldNumTel.getText(), parseInt(FieldMatricule.getText()), FieldMDP.getText());
    ...
    private void ButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonAddActionPerformed
        PersistanceTexte.Write(DateTimeFormatter.ofPattern("dd/MM/yyyy-HH:mm:ss").format(LocalDateTime.now()) + ">[" + getClass().getName() + "] " + Utilisateurpersonnel + " -> " + Thread.currentThread().getStackTrace()[1].getMethodName() + "_\n" , chemin_log);
        if(FieldNom.getText().equals("") && !FieldPrenom.getText().equals("") && !FieldAdresse.getText().equals("") && !FieldNumTel.getText().equals("") && !FieldMatricule.getText().equals("") && !FieldMDP.getText().equals(""))
        {
            boolean ok = true;
            ...
            for (Employe ListeEmploye1 : ListeEmploye) {
                matricule2 = ListeEmploye1.getMatricule();
